...
class WateringManagerPanel extends HTMLElement {
  ...
  overview(system) {
    ...
    return `<div class="grid stats">
      ...
      ${system.battery_sensor ? this.stat("mdi:battery", this.t("batteryLevel"), battery) : ""}
